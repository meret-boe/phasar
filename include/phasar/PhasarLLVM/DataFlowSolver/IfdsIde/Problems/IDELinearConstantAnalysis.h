...
public:
  ...
  IDELinearConstantAnalysis(const IDELinearConstantAnalysis& Other);
  IDELinearConstantAnalysis& operator=(IDELinearConstantAnalysis Other);

...
struct TypeStateDescription {
  ...
  [[nodiscard]] virtual std::set<int> getConsumerParamIdx(const std::string &F) const = 0;
  [[nodiscard]] virtual std::set<int> getFactoryParamIdx(const std::string &F) const = 0;

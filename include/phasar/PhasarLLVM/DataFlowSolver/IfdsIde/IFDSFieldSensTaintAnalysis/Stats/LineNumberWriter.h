...
public:
  LineNumberWriter(const class TraceStats &TraceStats, const std::string& OutFile)
...
#endif // PHASAR_PHASARLLVM_DATAFLOWSOLVER_IFDSIDE_IFDSFIELDSENSTAINTANALYSIS_STATS_LINENUMBERWRITER_H

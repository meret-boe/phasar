...
public:
  MapTaintedValuesToCallee(const llvm::CallInst *CallInst,
      ...
      : CallInst(CallInst), DestFun(DestFun), TraceStats(TraceStats),
        ZeroValue(ZeroValue) {}
...
#endif // PHASAR_PHASARLLVM_DATAFLOWSOLVER_IFDSIDE_IFDSFIELDSENSTAINTANALYSIS_FLOWFUNCTIONS_MAPTAINTEDVALUESTOCALLEE_H
